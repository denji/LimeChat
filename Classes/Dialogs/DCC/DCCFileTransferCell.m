...
- (void)drawInteriorWithFrame:(NSRect)frame inView:(NSView *)view
{
	...
	NSDictionary *fnameAttrs = [NSDictionary dictionaryWithObjectsAndKeys:
												 [[self class] fileNameStyle], NSParagraphStyleAttributeName, [NSFont systemFontOfSize:12], NSFontAttributeName, fnameColor, NSForegroundColorAttributeName, nil];
	...
	NSDictionary *statusAttrs = [NSDictionary dictionaryWithObjectsAndKeys:
												  [[self class] statusStyle], NSParagraphStyleAttributeName, [NSFont systemFontOfSize:11], NSFontAttributeName, statusColor, NSForegroundColorAttributeName, nil];
